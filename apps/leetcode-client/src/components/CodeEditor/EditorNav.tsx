  ...
  return (
    <div>
      <div
        ...
        className="px-4 rounded-t py-1 text-sm font-semibold bg-[rgb(49,48,48)]"
      >
        <div className="flex justify-between">
          ...
          <div className="pr-4">
            <button className="flex px-1 rounded items-center text-sm text-green-500 font-normal bg-[rgb(70,69,69)] hover:bg-[rgb(58,57,57)]">
